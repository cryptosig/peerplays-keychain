...
const getRC = name => {
  ...
  if (url === "DEFAULT") url = "https://api.mainnet.peerblock.trade/";
  return new Promise(function(fulfill, reject) {
    $.ajax({
      url: url,
      type: "POST",
...
function getPricesAsync() {
  return new Promise(function(resolve, reject) {
    $.ajax({
      ...
      url: "https://api.peerplays-keychain.com/ppy/p2pb2b",
      success: function(response) {
        resolve(response);
      },
      error: function(msg) {
...
function getWitnessRanks() {
  return new Promise(function(resolve, reject) {
    $.ajax({
      ...
      url: "https://api.peerplays-keychain.com/ppy/witnesses-ranks",
      success: function(response) {
        resolve(response);
      },
      error: function(msg) {
...
function getDelegators(name) {
  return new Promise(function(fulfill, reject) {
    $.ajax({
      ...
      url: "https://api.peerplays-keychain.com/ppy/delegators/" + name,
...
const getPhishingAccounts = async () => {
  return new Promise(function(fulfill, reject) {
    $.ajax({
      ...
      url: "https://api.peerplays-keychain.com/ppy/phishingAccounts",
