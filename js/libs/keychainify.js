...
const keychainify = {
  ...
  isUrlSupported: function(url) {
    return (
      (url.includes("ppysigner.com/sign/transfer") ||
      url.includes("ppysigner.com/sign/account-witness-vote") ||
      url.includes("ppysigner.com/sign/delegate-vesting-shares") ||
      url.includes("ppysigner.com/sign/account-witness-proxy"))
    );
  },
  ...
  keychainifyUrl: function(tab) {
    ...
    switch (true) {
       ...
       * Transfer fund
       */
      case (url.includes("ppysigner.com/sign/transfer")):
        defaults = {
          from: null,
          to: null,
          amount: 0,
       ...
       * Delegate GPOS Power
       */
      case (url.includes("ppysigner.com/sign/delegate-vesting-shares") ||
        url.includes("ppysigner.com/sign/delegate_vesting_shares")):
        defaults = {
          delegator: null,
          delegatee: null,
          amount: 0,
      ...
      case (url.includes("ppysigner.com/sign/account-witness-vote") ||
        url.includes("ppysigner.com/sign/account_witness_vote")):
        defaults = {
          account: null,
          witness: null,
          approve: "1"
        ...
        break;
      case (url.includes("https://ppysigner.com/sign/account-witness-proxy") ||
        url.includes("https://ppysigner.com/sign/account_witness_proxy")):
        defaults = {
          account: null,
          proxy: ""
        };
        ...
        break;
      //todo: probably doesn't work on ppy
      case (url.includes("https://ppysigner.com/sign/custom-json") ||
        url.includes("https://ppysigner.com/sign/custom_json")):
        defaults = {
          required_auths: null,
